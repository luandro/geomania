...
import { useSidebar, SidebarContext, type SidebarContext as SidebarContextType } from "./use-sidebar";
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Random width between 50 to 90% (React 19 compatible: use useState for impure initial value)
